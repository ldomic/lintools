...
class PiStacking(object):
    ...
    def make_table(self):
        ...
        for contact in self.timeseries:
            out[cursor] = (contact.frame, contact.time,contact.proteinring,contact.ligandring,contact.distance,contact.angle,contact.offset,
                            contact.type,contact.resid,contact.resname,contact.segid)
            cursor+=1
