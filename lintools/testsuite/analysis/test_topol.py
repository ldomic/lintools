...
class TestBasic1(TestCase):
    def setUp(self):
        ...
        self.lintools = Lintools(FILE1,None,lig_name,0,3.5,30,"amino",None,False,False,False,True,None,"test1")
...
class TestBasic2(TestCase):
    def setUp(self):
        ...
        self.lintools = Lintools(FILE1,None,lig_name,0,3.5,30,"domains",DOM_FILE_4XP1,False,False,False,True,None,"test2")
        self.lintools.get_info_about_input_and_analyse()
        self.lintools.plot_residues()
        self.lintools.draw_molecule_and_figure(tests=True)
    def tearDown(self):
...
class TestBasic3(TestCase):
    def setUp(self):
        ...
        self.lintools = Lintools(FILE2,[TRAJ_20_FR,TRAJ_50_FR],lig_name,30,3.5,50,"clock",None,False,False,False,True,None,"test3")
        self.lintools.get_info_about_input_and_analyse()
        self.lintools.plot_residues()
        self.lintools.draw_molecule_and_figure(tests=True)
    def tearDown(self):
...
class TestBasic4(TestCase):
    def setUp(self):
        ...
        self.lintools = Lintools(FILE2,[TRAJ_20_FR,TRAJ_50_FR],lig_name,30,3.5,50,"clock",None,False,True,False,False,None,"test4")
        self.lintools.get_info_about_input_and_analyse()
        self.lintools.plot_residues()
        self.lintools.draw_molecule_and_figure(tests=True)
    def tearDown(self):
